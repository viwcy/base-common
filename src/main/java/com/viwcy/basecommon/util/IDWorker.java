...
public class IDWorker {
    ...
    private static volatile IDWorker worker = null;
    /**
     * 开始时间截 (2022-01-01 00:00:00)
     */
     ...
     */
    public static final IDWorker getInstance(IDWorkerProperties properties) {
        if (worker == null) {
            synchronized (IDWorker.class) {
                if (worker == null) {
                    worker = new IDWorker(properties.getWorkerId(), properties.getDataCenterId());
                }
            }
        }
        return worker;
